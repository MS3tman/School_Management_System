...
<div class="sidebar">
    ...
    <div class="image">
        <img src="{{ asset('dist/img/Quackity.jpg') }}" class="img-circle elevation-2" alt="User Image">
    </div>
    <div class="info">
        <a href="#" class="d-block">Mahmoud 3tman</a>
    </div>
    </div>
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
        <a href="{{ url('attendance/index') }}" class="nav-link">
            <i class="nav-icon far fa-user"></i>
            <p>
            Attendance
            </p>
